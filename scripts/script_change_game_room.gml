if(global.pozicia_panaka > 25)
{
    global.aktualna_hracia_miestnost = hracia_miestnost_2;
    global.actual_game_object = game_character_object_two;
    room_goto(global.aktualna_hracia_miestnost);
}

/*
else if(global.pozicia_panaka < 26)
{
